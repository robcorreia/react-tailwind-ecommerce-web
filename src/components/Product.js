...
const Product = ({ product }) => {
  ...
  return (
    <div>
      <div
        className='border border-[#e4e4e4] h-[300px] rounded-lg mb-4 relative overflow-hidden group transition'
        key={product.id}
      >
        ...
        <div
          ...
          <div
            ...
            <img
              className='max-h-[160px] group-hover:scale-110 tarnsition duration-300'
              src={image}
              alt=''
            />
          </div>
